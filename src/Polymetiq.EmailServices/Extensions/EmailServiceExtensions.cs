...
{
    extension(IEmailService emailService)
    {
        /// <summary>
        ...
        public Task<EmailResult> SendAsync(string to, string subject, string? htmlBody, string? textBody)
        {
        ...
        public async Task<EmailResult> SendAsync(string to, string subject, string? body, bool isHtmlBody = true)
        {
